...
public class OSSClientUtil {
    ...
    // accessKey
    private String accessKeyId = "LTAIpgOzVVTDfrme";
    private String accessKeySecret = "o2PzJ6rEEYgxitslxDeyrE7r1376xF";
    // 空间
    private String bucketName = "ldlali";
    // 文件存储目录
    private String filedir = "ldlali/";
