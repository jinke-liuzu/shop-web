...
var _415=menu.attr("static.style")||"";
...
tr.attr("static.style",_833).attr("class",cls+_839);
if(_838){
tr.find("div.datagrid-cell-check input[type=checkbox]")._propAttr("checked",true);
}
};
...
_b3e.attr("static.style",cs.s).addClass(cs.c);
...
tmp.attr("static.style",_b4f.attr("static.style"));
...
_bde.attr("static.style",_be0);
tip.attr("static.style",_be0+"margin-left:"+(-Math.round(tip.outerWidth()/2))+"px");
}else{
var _be0="top:"+pos+"px;";
_bde.attr("static.style",_be0);
tip.attr("static.style",_be0+"margin-left:"+(-Math.round(tip.outerWidth()))+"px");
}
}
