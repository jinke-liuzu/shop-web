...
if(_28.mode=="h"){
var _31="left:"+pos+"px;";
_2f.attr("static.style",_31);
tip.attr("static.style",_31+"margin-left:"+(-Math.round(tip.outerWidth()/2))+"px");
}else{
var _31="top:"+pos+"px;";
_2f.attr("static.style",_31);
tip.attr("static.style",_31+"margin-left:"+(-Math.round(tip.outerWidth()))+"px");
}
}
